      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-background rounded-2xl p-8 text-center group shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:border-green-200">
            ...
            <h3 className="text-xl font-bold text-green-900 mb-4 font-serif">{t("feature1Title")}</h3>
          ...
          <div className="bg-background rounded-2xl p-8 text-center group shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:border-green-200">
            ...
            <h3 className="text-xl font-bold text-green-900 mb-4 font-serif">{t("feature2Title")}</h3>
            <p className="text-gray-600 leading-relaxed">
              {t("feature2Desc")}
            </p>
          </div>
          ...
          <div className="bg-background rounded-2xl p-8 text-center group shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:border-green-200">
            ...
            <h3 className="text-xl font-bold text-green-900 mb-4 font-serif">{t("feature3Title")}</h3>
            <p className="text-gray-600 leading-relaxed">
              {t("feature3Desc")}
            </p>
          </div>
          ...
          <div className="bg-background rounded-2xl p-8 text-center group shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:border-green-200">
            ...
            <h3 className="text-xl font-bold text-green-900 mb-4 font-serif">{t("feature4Title")}</h3>
            <p className="text-gray-600 leading-relaxed">
              {t("feature4Desc")}
            </p>
          </div>
          ...
          <div className="bg-background rounded-2xl p-8 text-center group shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:border-green-200">
            ...
            <h3 className="text-xl font-bold text-green-900 mb-4 font-serif">{t("feature5Title")}</h3>
            <p className="text-gray-600 leading-relaxed">
              {t("feature5Desc")}
            </p>
          </div>
          ...
          <div className="bg-background rounded-2xl p-8 text-center group shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 hover:border-green-200">
            ...
            <h3 className="text-xl font-bold text-green-900 mb-4 font-serif">{t("feature6Title")}</h3>
            <p className="text-gray-600 leading-relaxed">
              {t("feature6Desc")}
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-white">
            <div className="text-center">
              ...
              <div className="text-white/80">{t("statsProperties")}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold mb-2">5,000+</div>
              <div className="text-white/80">{t("statsUsers")}</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold mb-2">2,500+</div>
              <div className="text-white/80">{t("statsSales")}</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer className="bg-white py-6 border-t border-border/20">
      <div className="container mx-auto px-4 text-center text-gray-500">
        ...
        <div className="flex justify-center space-x-4 mt-2">
          <Link href="/terms" className="hover:text-[#3BB273]">{tAuth("termsAndConditions")}</Link>
          <Link href="/privacy" className="hover:text-[#3BB273]">{tAuth("privacyPolicy")}</Link>
          <Link href="/about" className="hover:text-[#3BB273]">{tLanding("about")}</Link>
        </div>
      </div>
    </footer>
  );
