// Test script for report messaging functionality
...
async function testReportMessaging() {
  try {
    console.log('Testing report messaging functionality...');
    ...
    const reportData = {
      title: 'Test Report',
      description: 'This is a test report to verify the messaging functionality',
      category: 'general',
    ...
    const testMessage = messages.find(msg => 
      msg.content.includes('Test Report') && 
